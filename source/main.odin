...
init :: proc() {
    ...
    food_sprite = k2.load_texture_from_bytes(#load("../assets/food.png"))
    head_sprite = k2.load_texture_from_bytes(#load("../assets/head.png"))
    body_sprite = k2.load_texture_from_bytes(#load("../assets/body.png"))
    tail_sprite = k2.load_texture_from_bytes(#load("../assets/tail.png"))
